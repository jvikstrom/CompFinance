...
inline double blackScholesIvol(const double spot, const double strike,
...
inline double BlackScholesKO(const double spot, const double rate,
                             const double div, const double strike,
                             const double barrier, const double mat,
                             const double vol) {
