...
Tape::iterator Tape::begin() { return myNodes.begin(); }

Tape::iterator Tape::end() { return myNodes.end(); }

Tape::iterator Tape::markIt() { return myNodes.mark(); }

Tape::iterator Tape::find(Node *node) { return myNodes.find(node); }
